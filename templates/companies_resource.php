                ...
                <div id="proIntroMenu" class="pro-intro-wrap">
                    <div class="pro-intro-menu">
                        <ul class="intro-menu-list clearfix">
                            <li <?php if($method=='detail'): ?>class="on"<?php endif; ?>><a href="<?=base_url()?>companies/detail/<?=$detail->id?>">公司介绍</a><i class="intro-flag"></i><i class="mdiv"></i></li>
                            <li <?php if($method=='project'): ?>class="on"<?php endif; ?>><a href="<?=base_url()?>companies/project/<?=$detail->id?>">案例库</a><i class="intro-flag"></i><i class="mdiv"></i></li>
                            <li <?php if($method=='resource'): ?>class="on"<?php endif; ?>><a href="<?=base_url()?>companies/resource/<?=$detail->id?>">资源列表</a><i class="intro-flag"></i></li>
                        </ul>
                    </div>
                    <div class="pro-intro-content">
                        <div class="pro-intro-items">
                            <div class="lib-case-inner clearfix">
                                <div class="lib-case-slide">
                                    <div class="case-side-inner">
                                        <?=$pre_link?>
                                        <div class="side-auto-wrap">
                                            <ul class="side-inner-list">
                                                <?php foreach ($resources_list as $key => $value) : ?>
                                                    <li>
                                ...
                                <div class="lib-case-list">
                                    <div class="lib-lab-wrap clearfix">
                                        ...
                                        <a href="<?=base_url()?>companies/resource/<?=$detail->id?>/<?=$value->classid?>" <?php if($classid==$value->classid): ?>class="on"<?php endif; ?>><?=$value->title?></a>
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="lib-project-wrap">
                                        <ul class="lib-project-list">
                                            <?php foreach ($resources_list as $key => $value) : ?>
                                                <li>
                                                    <div class="lib-project-title">
                                                        <a href="<?=base_url()?>resources/detail/<?=$value->id?>"><h1><?=$value->title?></h1></a>
