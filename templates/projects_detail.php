                    ...
                    <div class="pro-intro-content">
                        <div class="pro-intro-items">
                            ...
                            <div class="pro-location-wrap clearfix">
                                <div class="pro-location-img"><a href="#"><img width="200" height="150" src="<?=base_url().setting('attachment_dir').$detail->cover?>" alt=""/></a></div>
                                <div class="pro-location-info">
                                    ...
                                    <div class="pro-location-put clearfix">
                                        <div class="pro-location-view clearfix">
                                            <a class="location-view-link" href="<?=base_url()?>projects/news/<?=$detail->id?>">查看项目动态<i class="view-link-flag">&gt;</i></a><a class="location-view-link" href="<?=base_url()?>products/resource/<?=$detail->id?>">查看资源配置<i class="view-link-flag">&gt;</i></a>
                                        </div>
