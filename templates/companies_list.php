        ...
        <div class="res-main-inner">
            <div class="res-main-search clearfix">
                <div class="main-search-wrap clearfix">
                    <label class="main-search-lab" for="">公司库</label>
                ...
                <div class="res-view-wrap">
                    <div class="res-link-wrap clearfix">
                        <a class="res-link-all" href="<?=base_url()?>companies/index/">全部显示</a>
                    </div>
                </div>
            </div>
            <div id="resMainContent" class="res-main-content">
                <nav class="res-main-nav">
                    <dl class="res-main-items clearfix">
                            <dd style="float:none">
                                <ul class="res-main-list clearfix" style="margin-top:10px">
                                    <?php foreach($class_list as $v) : ?>
                                        <a href="<?=base_url()?>companies/index/<?=$v->classid?>">
                                            <li <?php if($classid==$v->classid):?>class="on"<?php endif;?> style="width:auto;margin:0 10px;padding:5px;height:auto">
                    ...
                    <div class="res-chance-items">
                        <ul class="news-list-items">
                            <?php foreach($list as $v) : ?>
                                <li>
                                    <a class="news-list-link" href="<?=base_url()?>companies/detail/<?=$v->id?>">
